...
from dataset import *
MODEL_FILE = "inception_model.pth"
VOCAB_FILE = "flickr30k_vocab.pkl"
# Replace with your image directory in your computer
image_path ="D:/HUST/20241/Intro to deep learning/flickr8k/Images/485921585_1974b1577a.jpg"
...
model = load_model(MODEL_FILE, vocab_size=len(vocab), embed_size=300, attention_dim=256, encoder_dim=2048, decoder_dim=512)
